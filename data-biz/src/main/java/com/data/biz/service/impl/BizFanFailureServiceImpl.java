...
public class BizFanFailureServiceImpl implements IBizFanFailureService {
    ...
    public int insertBizFanFailure(FanAlertManageVo fanAlertManageVo) {
        return bizFanFailureMapper.insertBizFanFailure(fanAlertManageVo);
    }
    ...
    public int updateBizFanFailure(FanAlertManageVo fanAlertManageVo) {
        return bizFanFailureMapper.updateBizFanFailure(fanAlertManageVo);
    }
    ...
    public FanAlertManageVo transitionFanAlertManageVo(BizFanFailure bizFanFailure) {
        ...
        fanAlertManageVo.setLevel(bizFanFailure.getLevel());
        fanAlertManageVo.setRecord(bizFanFailure.getRecord());
